class CreateTexasCampaignFinanceCommittees < ActiveRecord::Migration
  def change
    create_table :texas_campaign_finance_committees do |t|
    ...
    execute 'ALTER TABLE texas_campaign_finance_committees MODIFY id bigint(20) DEFAULT NULL auto_increment NOT NULL'
  end
end
