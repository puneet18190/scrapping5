class CreateTexasCampaignFinanceContributions < ActiveRecord::Migration
  def change
    create_table :texas_campaign_finance_contributions do |t|
    ...
    execute 'ALTER TABLE texas_campaign_finance_contributions MODIFY id bigint(20) DEFAULT NULL auto_increment NOT NULL'
  end
end
