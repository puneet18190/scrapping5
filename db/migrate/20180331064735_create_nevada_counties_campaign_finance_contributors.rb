class CreateNevadaCountiesCampaignFinanceContributors < ActiveRecord::Migration
  def change
    create_table :nevada_counties_campaign_finance_contributors do |t|
    ...
    execute 'ALTER TABLE nevada_counties_campaign_finance_contributors MODIFY id bigint(20) DEFAULT NULL auto_increment NOT NULL'
  end
end
